...
WHEN {Degree of Relation2}=13 and {Gender}=1 and {Gender Unknown}=0 AND {Degree of Relation}=2 and {Father ID} < {Mother ID} THEN 'Nephew through Brother'
WHEN {Degree of Relation2}=13 and {Gender}=1 and {Gender Unknown}=0 AND {Degree of Relation}=2 and {Father ID} > {Mother ID} THEN 'Nephew through Sister'
WHEN {Degree of Relation2}=13 and {Gender}=0 and {Gender Unknown}=0 AND {Degree of Relation}=2 and {Father ID} < {Mother ID} THEN 'Niece through Brother'
WHEN {Degree of Relation2}=13 and {Gender}=0 and {Gender Unknown}=0 AND {Degree of Relation}=2 and {Father ID} > {Mother ID} THEN 'Niece through Sister'
